...
bool PlayerInformationScene::init()
{
	...
	auto border1 = Sprite::create("Trophy/Achievement Border.png");
	border1->setPosition(Vec2(visibleSize.width*0.2, visibleSize.height*0.38));
	Tool::setNodeSize(border1, visibleSize.width*0.32, visibleSize.height*0.6);
	this->addChild(border1);

	auto border2 = Sprite::create("Trophy/Achievement Border.png");
	border2->setPosition(Vec2(visibleSize.width*0.5, visibleSize.height*0.38));
	Tool::setNodeSize(border2, visibleSize.width*0.32, visibleSize.height*0.6);
	this->addChild(border2);

	auto border3 = Sprite::create("Trophy/Achievement Border.png");
	border3->setPosition(Vec2(visibleSize.width*0.8, visibleSize.height*0.38));
	...
	auto btn_CardScene = Tool::CreateButtonWithoutSprite("btn_CardScene", "Go To Card >>", Tool::defaultTextSize);
	btn_CardScene->runAction(RepeatForever::create(Sequence::create(
		MoveBy::create(1, Vec2(-25, 0)),
		MoveBy::create(1, Vec2(25, 0)),
		nullptr)));
	btn_CardScene->setPosition(Vec2(visibleSize.width*0.88, visibleSize.height*0.05));
	...
	if (knowledge.level != 0) {
		...
		sp_Knowledge->setPosition(Vec2(visibleSize.width*0.2, visibleSize.height*0.45));
		...
		lbl_BonusKnowledge->setPosition(Vec2(visibleSize.width*0.2, visibleSize.height*0.17));
	...
	lbl_TotalCorrectAnswer->setPosition(Vec2(visibleSize.width*0.2, visibleSize.height*0.8));
	...
	correntAnswerBar->setPosition(Vec2(visibleSize.width*0.2, visibleSize.height*0.75));
	...
	lbl_AnswerAccurary->setPosition(Vec2(visibleSize.width*0.2, visibleSize.height*0.7));
	this->addChild(lbl_AnswerAccurary);

	auto lbl_TotalWin = Tool::CreateLabel("Total Win");
	lbl_TotalWin->setPosition(Vec2(visibleSize.width*0.5, visibleSize.height*0.8));
	...
	winBar->setPosition(Vec2(visibleSize.width*0.5, visibleSize.height*0.75));
	...
	lbl_Winrate->setPosition(Vec2(visibleSize.width*0.5, visibleSize.height*0.7));
	this->addChild(lbl_Winrate);

	auto lbl_TotalKill = Tool::CreateLabel("Total Kill");
	lbl_TotalKill->setPosition(Vec2(visibleSize.width*0.8, visibleSize.height*0.8));
	...
	killBar->setPosition(Vec2(visibleSize.width*0.8, visibleSize.height*0.75));

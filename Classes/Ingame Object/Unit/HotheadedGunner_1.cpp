#include "HotheadedGunner_1.h"

HotheadedGunner_1::HotheadedGunner_1(int line, bool isOwned, int unitId, int playerId)
{
	name = "Hotheaded Gunner 1";
...
void HotheadedGunner_1::onDamageReceive(DamageReceive dmg) {
...
HotheadedGunner_1::~HotheadedGunner_1()
{
}

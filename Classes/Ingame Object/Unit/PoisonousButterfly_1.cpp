#include "PoisonousButterfly_1.h"

PoisonousButterfly_1::PoisonousButterfly_1(int line, bool isOwned, int unitId, int playerId)
{
	name = "Poisonous Butterfly 1";
...
PoisonousButterfly_1::~PoisonousButterfly_1()
{
}
...
void PoisonousButterfly_1::Regeneration()
{
...
void PoisonousButterfly_1::Attack(vector<BaseUnitClass*>& targets)
{
	this->action = "Attack";

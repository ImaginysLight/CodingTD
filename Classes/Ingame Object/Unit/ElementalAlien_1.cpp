#include "ElementalAlien_1.h"

ElementalAlien_1::ElementalAlien_1(int line, bool isOwned, int unitId, int playerId)
{
	name = "Elemental Alien 1";
...
ElementalAlien_1::~ElementalAlien_1()
{
}

void ElementalAlien_1::Attack(vector<BaseUnitClass*>& targets)
{
	this->action = "Attack";

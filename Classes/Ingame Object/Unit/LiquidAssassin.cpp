#include "LiquidAssassin.h"

LiquidAssassin::LiquidAssassin(int line, bool isOwned, int unitId, int playerId)
{
...
void LiquidAssassin::Attack(vector<BaseUnitClass*>& targets)
{
...
vector<BaseUnitClass*> LiquidAssassin::FindTargets()
{

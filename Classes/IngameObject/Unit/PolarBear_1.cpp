#include "PolarBear_1.h"

PolarBear_1::PolarBear_1(int line, bool isOwned, int unitId, int playerId)
{
	name = "Polar Bear 1";
...
PolarBear_1::~PolarBear_1()
{
}

void PolarBear_1::Attack(vector<BaseUnitClass*>& targets)
{
	numOfAttack++;
...
void PolarBear_1::onDamageReceive(DamageReceive dmg)
{

#include "WingedOrc_1.h"

WingedOrc_1::WingedOrc_1(int line, bool isOwned, int unitId, int playerId)
{
	name = "Winged Orc 1";
...
void WingedOrc_1::Attack(vector<BaseUnitClass*>& targets)
{
	this->action = "Attack";

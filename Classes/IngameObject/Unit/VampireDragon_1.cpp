#include "VampireDragon_1.h"

VampireDragon_1::VampireDragon_1(int line, bool isOwned, int unitId, int playerId)
{
	name = "Vampire Dragon 1";
...
VampireDragon_1::~VampireDragon_1()
{
}

void VampireDragon_1::Attack(vector<BaseUnitClass*>& targets)
{
	this->action = "Attack";
